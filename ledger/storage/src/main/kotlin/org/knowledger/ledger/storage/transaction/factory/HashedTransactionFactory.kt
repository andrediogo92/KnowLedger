...
internal class HashedTransactionFactory : TransactionFactory {
    ...
    private fun generateHashAndSize(
        ...
        SignedTransactionImpl(publicKey, data, signature),
        hasher, encoder
    )
    ...
    ): HashedTransactionImpl = create(
        privateKey, TransactionImpl(publicKey, data),
    ...
    override fun create(
        ...
        create(publicKey, data, signature, hash, approximateSize)
    }

    override fun create(
        other: MutableTransaction
    ): HashedTransactionImpl =
        create(other as HashedTransaction)
}