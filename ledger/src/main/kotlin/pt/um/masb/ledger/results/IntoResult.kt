...
fun <T : Any> LoadResult<out LedgerContract>.intoQuery(): QueryResult<T> =
    when (this) {
        is LoadResult.Success -> QueryResult.QueryFailure(
            "LoadResult can't auto-convert into QueryResult."
        )
        is LoadResult.QueryFailure ->
            QueryResult.QueryFailure(cause, exception)
        is LoadResult.NonExistentData ->
