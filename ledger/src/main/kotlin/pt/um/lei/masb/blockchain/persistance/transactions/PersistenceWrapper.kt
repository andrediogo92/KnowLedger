package pt.um.lei.masb.blockchain.persistance.transactions
...
import pt.um.lei.masb.blockchain.persistance.loaders.QueryLoadable
...
import pt.um.lei.masb.blockchain.persistance.query.SimpleBinaryOperator
...
import pt.um.lei.masb.blockchain.results.*
...
internal class PersistenceWrapper(
     ...
     * to attempt to grab for hashing operations.
     * - The persistance wrapper itself.
     *
