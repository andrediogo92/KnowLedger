 ...
 */
enum class HUnit : PhysicalUnit, ConvertableUnit<BigDecimal, HUnit> {
    RELATIVE {
        override fun convertTo(value: BigDecimal, to: HUnit): BigDecimal = value
    },
    G_BY_KG {
        override fun convertTo(value: BigDecimal, to: HUnit): BigDecimal = when (to) {
