...
class TestMerkleTree {
    ...
    @Test
    fun testMerkleTreeBalanced() {
        val id = arrayOf(
            Ident.generateNewIdent(),
            Ident.generateNewIdent()
        )
        val ts = makeXTransactions(id, 8)
    ...
    @Test
    fun testMerkleTreeUnbalanced() {
        val id = arrayOf(
            Ident.generateNewIdent(),
            Ident.generateNewIdent()
        )
        val ts = makeXTransactions(id, 6)
        val tree = MerkleTree.buildMerkleTree(ts)
    ...
    @Test
    fun testMerkleTreeUnbalancedCoinbase() {
        val id = arrayOf(
            Ident.generateNewIdent(),
            Ident.generateNewIdent()
        )
        val ts = makeXTransactions(id, 5)
        val coinbase = generateCoinbase(id, ts)
        val tree = MerkleTree.buildMerkleTree(coinbase, ts)
    ...
    @Test
    fun testMerkleSingleVerification() {

        val id = arrayOf(
            Ident.generateNewIdent(),
            Ident.generateNewIdent()
        )
        var ts = makeXTransactions(id, 8)
    ...
    @Test
    fun testMerkleAllVerification() {

        val id = arrayOf(
            Ident.generateNewIdent(),
            Ident.generateNewIdent()
        )
        var ts = makeXTransactions(id, 6)
        var coinbase = generateCoinbase(id, ts)
        var tree = MerkleTree.buildMerkleTree(coinbase, ts)
