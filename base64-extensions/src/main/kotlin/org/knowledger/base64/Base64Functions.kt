...
fun String.base64Encoded(): Base64String = encodedStringInUTF8().base64Encoded()

fun ByteArray.base64Encoded(): Base64String = b64Encoder.encodeToString(this)

fun Base64String.base64Decoded(): ByteArray = b64Decoder.decode(this)
...
fun Base64String.base64DecodedToUTF8(): String = base64Decoded().decodedUTF8String()
