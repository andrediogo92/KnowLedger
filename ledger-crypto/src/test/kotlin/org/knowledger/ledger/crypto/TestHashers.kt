...
class TestHashers {
    ...
    inner class SHA {
        @Test
        fun `apply sha-256`() {
            assertThat(Hashers.SHA256Hasher.applyHash(test).print)
                .isEqualTo("6EC7BBB8088AD0582BA4CCA03667C20BA7A58F5A6CBAB23706B6F4260CAECC5A")
        }

        @Test
        fun `apply sha-512`() {
            assertThat(Hashers.SHA512Hasher.applyHash(test).print)
    ...
    inner class Blake2 {
        ...
        fun `apply blake2s-256`() {
            assertThat(Hashers.Blake2s256Hasher.applyHash(test).print)
        ...
        fun `apply blake2b-256`() {
            assertThat(Hashers.Blake2b256Hasher.applyHash(test).print)
                .isEqualTo("6A1FAE02BBF98D1A96C99C38F616D4559E527E3CC1A719A996C093A7867C8FFA")
        }

        @Test
        fun `apply blake2b-512`() {
            assertThat(Hashers.Blake2b512Hasher.applyHash(test).print)
    ...
    inner class SHA3 {
        @Test
        fun `apply sha3-256`() {
            assertThat(Hashers.SHA3256Hasher.applyHash(test).print)
                .isEqualTo("8F42B68F1B239CD0F9F51EABFD43DAE5775CB1531E1CC64444115D1582518283")
        }

        @Test
        fun `apply sha3-512`() {
            assertThat(Hashers.SHA3512Hasher.applyHash(test).print)
    ...
    inner class Keccak {
        ...
        fun `apply keccak-256`() {
            assertThat(Hashers.Keccak256Hasher.applyHash(test).print)
        ...
        fun `apply keccak-512`() {
            assertThat(Hashers.Keccak512Hasher.applyHash(test).print)
